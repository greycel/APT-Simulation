...
IF "%PROCESSOR_ARCHITECTURE%"=="AMD64" (C:\Windows\syswow64\regsvr32.exe /s %Utilities%\APT19\AllTheThingsx86.dll) ELSE ( regsvr32.exe /s %Utilities%\APT19\AllTheThingsx86.dll )
ECHO.
